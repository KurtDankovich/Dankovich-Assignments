...
function viewCurrentContact(){
    ...
    document.getElementById("myCity").value = currentContact.city;
    document.getElementById("myState").value = currentContact.state;
    document.getElementById("myZip").value = currentContact.zip;
...
function getPlace(){
    ...
    var krd = new XMLHttpRequest();


    krd.onreadystatechange = function () {
        if (krd.readyState == 4 && krd.status == 200){
            var result = krd.responseText;
            ...
            krd.open("GET", "getCityState.php?zip=" + zip);
            krd.send(null);
...
function initApplication(){
    ...
    console.log('Mustange V2 is starting')
    loadIndex();
    loadContacts();
